...
export const TRADE_SCENARIOS: TradeScenario[] = [
    ...
    teams: [
      ...
      },
      {
        ...
        players: [
          ...
          { id: 'ball', name: 'Lonzo Ball', team: 'bulls', position: 'PG', salary: 20.0, age: 25, rating: 68, yearsLeft: 2 },
          { id: 'derozan', name: 'DeMar DeRozan', team: 'bulls', position: 'SF', salary: 28.6, age: 34, rating: 81, yearsLeft: 1 },
        ],
        picks: [
  ...
  {
    id: 'kyrie-boston-2017',
    title: 'Kyrie to Boston: The IT Trade',
    year: 2017,
    ...
    teams: [
      {
        ...
        taxLine: 119.3,
        players: [
          { id: 'it', name: 'Isaiah Thomas', team: 'celtics', position: 'PG', salary: 6.9, age: 28, rating: 87, yearsLeft: 1 },
          { id: 'crowder', name: 'Jae Crowder', team: 'celtics', position: 'SF', salary: 7.3, age: 27, rating: 75, yearsLeft: 1 },
          { id: 'zizic', name: 'Ante Zizic', team: 'celtics', position: 'C', salary: 1.5, age: 20, rating: 70, yearsLeft: 2 },
          { id: 'tatum', name: 'Jayson Tatum', team: 'celtics', position: 'SF', salary: 5.4, age: 19, rating: 79, yearsLeft: 3, isUntouchable: true },
          { id: 'brown', name: 'Jaylen Brown', team: 'celtics', position: 'SG', salary: 4.7, age: 20, rating: 77, yearsLeft: 2 },
        ],
        picks: [
          { id: 'bos-2018-1', year: 2018, team: 'Celtics (Brooklyn pick)', estimatedValue: 9 },
          { id: 'bos-2020-1', year: 2020, team: 'Celtics', estimatedValue: 6 },
        ],
        needs: ['PG', 'star', 'superstar scoring'],
        winPct: 0.646,
        playoffOdds: 0.95,
      },
      {
        ...
        taxLine: 119.3,
        players: [
          { id: 'kyrie-cle', name: 'Kyrie Irving', team: 'cavaliers', position: 'PG', salary: 18.9, age: 25, rating: 93, yearsLeft: 1 },
          { id: 'tristan', name: 'Tristan Thompson', team: 'cavaliers', position: 'C', salary: 15.3, age: 26, rating: 76, yearsLeft: 3 },
        ],
        picks: [],
        needs: ['SG', 'scoring depth', 'young talent'],
        winPct: 0.622,
        playoffOdds: 0.92,
      },
    ],
    historicalOutcome: {
      summary: 'Boston sent IT, Jae Crowder, Ante Zizic, and the Brooklyn Nets\' 2018 pick (went #8) to Cleveland for Kyrie. IT was hurt at the time, never recovered. Kyrie left Boston after 2 years. The Brooklyn pick became Collin Sexton for Cleveland.',
      winsChange: { celtics: -1, cavaliers: +2 },
      capImpact: { celtics: 'Took on Kyrie\'s $19M for 2 years. Lost beloved Isaiah Thomas.', cavaliers: 'Got a high lottery pick + IT (damaged goods). Kyrie helped them reach Finals.' },
      verdict: 'Disputed. Boston got a star but lost IT\'s magic + the 8th pick. Kyrie leaving hurt long-term. Cleveland got assets for a rebuilding piece.',
      score: 55,
    },
  },
  {
    id: 'harden-houston-2021',
    title: 'Houston\'s Dilemma: Harden Demands Out',
    year: 2021,
    ...
    teams: [
      {
        ...
        taxLine: 132.6,
        players: [
          { id: 'harden-hou', name: 'James Harden', team: 'rockets', position: 'PG', salary: 41.3, age: 31, rating: 95, yearsLeft: 2 },
          { id: 'wood-hou', name: 'Christian Wood', team: 'rockets', position: 'C', salary: 13.6, age: 25, rating: 80, yearsLeft: 2 },
          { id: 'wall', name: 'John Wall', team: 'rockets', position: 'PG', salary: 44.3, age: 30, rating: 74, yearsLeft: 1 },
        ],
        picks: [
          { id: 'hou-2021-1', year: 2021, team: 'Rockets', estimatedValue: 3 },
          { id: 'hou-2022-1', year: 2022, team: 'Rockets', estimatedValue: 4 },
        ],
        needs: ['future picks', 'young talent', 'rebuilding assets'],
        winPct: 0.171,
        playoffOdds: 0.02,
      },
      {
        ...
        taxLine: 132.6,
        players: [
          { id: 'kd-nets', name: 'Kevin Durant', team: 'nets', position: 'SF', salary: 39.1, age: 32, rating: 97, yearsLeft: 3, isUntouchable: true },
          { id: 'kyrie-nets', name: 'Kyrie Irving', team: 'nets', position: 'PG', salary: 33.5, age: 28, rating: 92, yearsLeft: 1, isUntouchable: true },
          { id: 'levert', name: 'Caris LeVert', team: 'nets', position: 'SG', salary: 18.3, age: 26, rating: 78, yearsLeft: 2 },
          { id: 'allen-nets', name: 'Jarrett Allen', team: 'nets', position: 'C', salary: 9.4, age: 22, rating: 79, yearsLeft: 1 },
          { id: 'dinwiddie', name: 'Spencer Dinwiddie', team: 'nets', position: 'PG', salary: 10.6, age: 27, rating: 75, yearsLeft: 1 },
        ],
        picks: [
          { id: 'bkn-2022-1', year: 2022, team: 'Nets', estimatedValue: 6 },
          { id: 'bkn-2024-1', year: 2024, team: 'Nets', estimatedValue: 5 },
          { id: 'bkn-2026-1', year: 2026, team: 'Nets', estimatedValue: 5 },
          { id: 'bkn-2028-1', year: 2028, team: 'Nets', estimatedValue: 5 },
        ],
        needs: ['3rd star', 'PG', 'ball handler'],
        winPct: 0.610,
        playoffOdds: 0.92,
      },
    ],
    historicalOutcome: {
      summary: 'Houston received LeVert + Allen + Dinwiddie + 4 unprotected first-round picks + 4 pick swaps. All 4 picks conveyed as top-4 selections during Houston\'s rebuild. A generational haul.',
      winsChange: { rockets: -8, 'nets-2021': +5 },
      capImpact: { rockets: 'Received massive pick capital — built OKC-style rebuild around 4 lottery picks', 'nets-2021': 'Locked in $300M+ for Big 3. No flexibility for years.' },
      verdict: 'Houston won long-term — 4 unprotected picks became lottery picks. Brooklyn got 13 months of Harden before he left. Your job: squeeze as much as they did or more.',
      score: 85,
    },
  },
  {
    ...
    teams: [
      {
        ...
        players: [
          ...
          { id: 'cp3', name: 'Chris Paul', team: 'suns', position: 'PG', salary: 30.8, age: 37, rating: 79, yearsLeft: 1 },
